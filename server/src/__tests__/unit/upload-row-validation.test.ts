    ...
    const rows = [
      {
        ...
        estimatedEffortWithoutAi: 10000,
        actualEffortWithAi: null,
        aiUsed: null,
        devStartDate: null,
        devEndDate: null,
...
describe('UploadService - Persistence orchestration', () => {
    ...
    const data = [
      {
        ...
        'Project ': 'IBPS-POS',
        'Items list': 'Item 1',
        'Walkthrough given on (To Dev team)': '15-01-2024',
        'JIRA ID': 'PROJ-123',
        'Dev Start ': '01-01-2024',
        'Dev End Date': '15-01-2024',
        'Estimated Effort With AI (SP)': 5,
        ...
        'AI Used (Y/N)': 'Y',
        'Estimated Effort Without AI (Hrs)': 8,
  ...
  it('should fall back to track name when no portfolio mapping exists', async () => {
    ...
    const data = [
      {
        'Sno': 1,
        'Project ': 'UnknownTrack',
        'Items list': null,
        'Walkthrough given on (To Dev team)': null,
        'JIRA ID': 'UNK-1',
        'Dev Start ': null,
        'Dev End Date': null,
        'Estimated Effort With AI (SP)': null,
        ...
        'Rollback Reason': null,
        'AI Used (Y/N)': null,
        'Estimated Effort Without AI (Hrs)': null,
