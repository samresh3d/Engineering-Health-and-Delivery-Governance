...
- [x] 2. Set up project structure and core interfaces
  ...
  - [x] 2.2 Define shared TypeScript types and interfaces
...
- [x] 12. Implement Dashboard frontend
  - [x] 12.1 Set up React application with routing and theme
    ...
    - Create `/client/src/theme/` with platform branding: primary Burgundy/Maroon, white backgrounds, light grey secondary, dark grey text
...
- [x] 15. Checkpoint - All tests pass
  - Ensure all tests pass, ask the user if questions arise.
  - [x] 15.1 Commit progress
    - Stage all changes: `git add -A`
    - Commit with message: `git commit -m "test: integration and property-based tests"`
    - _Covers task 14_

- [x] 16. Push to feature branch
  - [x] 16.1 Push all commits to a new remote branch
